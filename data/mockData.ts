...
export const SUCCESS_STORIES: SuccessStory[] = [
  {
    ...
    testimonial: 'GYNAM’s TCS-pattern Mock Tests and calculation speed shortcuts helped me score 342/390 in Mains. The strategy sessions kept me focused throughout my 1-year journey.',
    previousAttempts: 'Targeted AIR 1 with GYNAM Full Batch',
    hometown: 'Delhi NCR',
  ...
  },
  {
    ...
    videoDuration: '11:45',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'GYNAM’s TCS-pattern Mock Tests and Rakesh Sir’s Maths shortcuts transformed my score from 120 to 184 in Tier-1. The daily analytics showed me exactly where I lost time.',
  ...
  },
  {
    ...
    videoDuration: '09:15',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'The high-level Puzzles masterclasses and 1-on-1 mock interviews at GYNAM were the turning point for my SBI & IBPS PO prep. Government jobs are truly made easy here!',
  ...
  },
  {
    ...
    videoDuration: '18:10',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'Preparing for Assam state exams used to be confusing with outdated books. GYNAM provided structured Assamese & English notes and Assam GK modules that guaranteed my selection.',
  ...
  },
  {
    ...
    videoDuration: '15:30',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'Dr. Nanda Sir’s daily answer writing feedback was unmatched. GYNAM provided the exact structure needed for UPSC mains without blowing up tuition fees.',
  ...
  },
  {
    ...
    videoDuration: '12:05',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'The dedicated Assam Heritage & History notes along with mock interview panels at GYNAM Guwahati center helped me secure Rank 3 in APSC Civil Services.',
  ...
  },
  {
    ...
    videoDuration: '08:50',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'NCERT General Science breakdown and RRB shift-wise PYQs from GYNAM made CBT-1 and CBT-2 smooth sailing. Reached 99.8 percentile in speed tests.',
    previousAttempts: '1st Attempt Clearance',
  ...
  },
  {
    ...
    videoDuration: '10:40',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'Banking Awareness capsules and Speed Math shortcuts allowed me to crack SBI PO in my very first attempt. GYNAM mentorship is top notch!',
  ...
  },
  {
    ...
    hasVideo: false,
    testimonial: 'GYNAM Assam State Special mocks prepared me for the tough GK & Language sections in ADRE 3.0. Highly recommended for Assam aspirants!',
  ...
  },
  {
    ...
    videoDuration: '11:20',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'Speed tests and daily doubt clearing at GYNAM boosted my typing & tier 2 score. Secured AIR 2 with 310/360 marks!',
  ...
  },
  {
    ...
    hasVideo: false,
    testimonial: 'Accuracy is key in IBPS Clerk Mains. GYNAM mock series simulated the exact exam interface and difficulty level.',
  ...
  },
  {
    ...
    videoDuration: '13:00',
    youtubeUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
    testimonial: 'Physical endurance guidance combined with Essay Writing workshops by GYNAM ex-officers made my CAPF dream a reality.',
...
export const CURRENT_AFFAIRS_ITEMS: CurrentAffairItem[] = [
  {
    ...
    author: 'Dr. V. K. Nanda & GYNAM Banking Team',
  ...
  },
  {
    ...
    bullets: [
      ...
      'GYNAM Assam special study modules & Assamese test series launched.'
    ],
  ...
  },
  {
    ...
    author: 'GYNAM Science & Defense Desk',
  ...
  },
  {
    ...
    author: 'GYNAM UPSC Editorial Desk',
  ...
  },
  {
    ...
    author: 'GYNAM Schemes & Policy Desk',
...
export const FREE_RESOURCES: FreeResource[] = [
  {
    id: 'res-1',
    title: 'GYNAM Monthly Current Affairs Magazine - July 2026 Print Edition',
    type: 'Magazine',
    category: 'All Govt Exams',
    fileSize: '120 Pages Hardcover',
    ...
    price: 149,
    reviewsCount: 1420,
    author: 'GYNAM Current Affairs Editorial Board',
    ...
    publisher: 'GYNAM Academic Publications',
    isbn: '978-93-89102-14-1',
    edition: 'July 2026 Print Edition',
    weight: '220 grams',
    inStock: true
  },
  {
    id: 'res-2',
    title: 'SSC CGL Tier-1 Last 10 Years Solved PYQ Papers Book (2016 - 2025)',
    type: 'PYQ Paper',
    category: 'SSC',
    fileSize: '240 Pages Book',
    downloadsCount: 68900,
    rating: 4.95,
    description: 'Original shift-wise question papers with official answer keys, detailed step-by-step explanations, and short tricks by GYNAM Faculty.',
    language: 'English',
    pagesCount: 240,
    ...
    price: 299,
    reviewsCount: 2890,
    author: 'GYNAM SSC Research Wing',
    badge: '10 YEARS SOLVED PYQs',
    ...
    publisher: 'GYNAM SSC Research Wing',
    isbn: '978-93-89102-28-8',
  ...
  {
    id: 'res-3',
    title: 'Assam History, Geography & Culture Master Theory Book',
    type: 'Book',
    category: 'Assam Govt',
    fileSize: '210 Pages Hardcover',
    downloadsCount: 35100,
    rating: 4.98,
    description: 'Hardcover textbook covering Ahom Dynasty timeline, Freedom Movement in Assam, 7 National Parks, Rivers & Culture with maps.',
    ...
    price: 299,
    reviewsCount: 1850,
    author: 'Prof. J. Baruah & GYNAM Assam Team',
    badge: 'ASSAM MASTER BOOK',
    ...
    publisher: 'GYNAM Assam Heritage Press',
    isbn: '978-93-89102-35-6',
  ...
  {
    id: 'res-4',
    title: '10,000 General Studies Chapter-Wise Practice Question Bank',
    type: 'Question Bank',
    category: 'UPSC & State PSC',
    fileSize: '380 Pages Book',
    downloadsCount: 58200,
    rating: 4.94,
    description: 'Massive question bank containing 10,000+ topic-wise MCQs covering History, Polity, Geography, Economy, and General Science with explanations.',
    language: 'English',
    pagesCount: 380,
    chapters: ['Ancient & Medieval India 2000 MCQs', 'Modern History & National Movement 2500 MCQs', 'Indian Polity & Constitution 2500 MCQs', 'Indian Economy & Physical Geography 3000 MCQs'],
    updatedDate: '10 July 2026',
    targetExams: ['SSC CGL', 'UPSC CSE', 'APSC CCE', 'Assam ADRE 3.0'],
    isHot: true,
    originalPrice: 699,
    price: 399,
    reviewsCount: 3420,
    author: 'GYNAM Faculty Editorial Board',
    badge: '10,000+ MCQs BANK',
    coverBg: 'from-amber-700 to-red-950',
    ...
    publisher: 'GYNAM National Publications',
    isbn: '978-93-89102-42-4',
    edition: '2026 Master Vol 1',
    weight: '580 grams',
    inStock: true
  },
  {
    id: 'res-5',
    title: 'Assam ADRE 3.0 Complete Faculty Printed Course Material Kit (Set of 5 Books)',
    type: 'Course Material',
    category: 'Assam Govt',
    fileSize: '750 Pages Complete Box Set',
    downloadsCount: 24100,
    rating: 4.99,
    description: 'Official printed study module box set containing 5 dedicated textbooks: Assam GK, General English, Quantitative Aptitude, Logical Reasoning, and 15 Mock Test Papers.',
    language: 'Bilingual (Assamese + Eng)',
    pagesCount: 750,
    chapters: ['Book 1: Complete Assam GK & NE Studies', 'Book 2: Quantitative Aptitude & Data Analysis', 'Book 3: General Intelligence & Reasoning', 'Book 4: General English & Grammar', 'Book 5: 15 Full Length Mock Tests'],
    updatedDate: '28 July 2026',
    targetExams: ['Assam ADRE 3.0 SLRC Grade III & IV'],
    isHot: true,
    originalPrice: 1499,
    price: 899,
    reviewsCount: 4210,
    author: 'GYNAM Senior Faculty Board',
    badge: 'FULL FACULTY KIT',
    coverBg: 'from-red-800 to-slate-900',
    ...
    publisher: 'GYNAM SLRC Special Press',
    isbn: '978-93-89102-50-9',
    edition: 'ADRE 3.0 Special Box Set',
    weight: '1,250 grams',
    inStock: true
  },
  {
    id: 'res-6',
    title: 'IBPS PO & SBI PO Memory Based PYQ Papers Book (2020 - 2025)',
    type: 'PYQ Paper',
    category: 'Banking',
    fileSize: '160 Pages Book',
    ...
    price: 269,
    reviewsCount: 1640,
    author: 'GYNAM Banking Expert Panel',
    badge: 'BANKING PYQs',
    ...
    publisher: 'GYNAM Banking Research Desk',
    isbn: '978-93-89102-61-5',
  ...
  {
    id: 'res-7',
    title: '5,000 High-Yield Quantitative Aptitude Question Bank with Video Solutions QR',
    type: 'Question Bank',
    category: 'SSC & Banking',
    fileSize: '310 Pages Book',
    downloadsCount: 38900,
    rating: 4.91,
    description: 'Level-1, Level-2, and Level-3 topic-wise question bank with QR codes printed next to every question for step-by-step video solutions.',
    language: 'English',
    pagesCount: 310,
    chapters: ['Number System & Simplification 1000 MCQs', 'Arithmetic Word Problems 2000 MCQs', 'Data Interpretation & Sufficiency 1200 MCQs', 'Advanced Maths (Algebra & Geometry) 800 MCQs'],
    updatedDate: '18 July 2026',
    targetExams: ['SSC CGL', 'IBPS PO', 'SBI PO', 'RRB NTPC'],
    originalPrice: 599,
    price: 349,
    reviewsCount: 2150,
    author: 'Er. R. Sharma (Maths HOD)',
    badge: 'QUANT QUESTION BANK',
    coverBg: 'from-orange-700 to-red-900',
    ...
    publisher: 'GYNAM Math Press',
    isbn: '978-93-89102-72-1',
    edition: 'Smart Video QR Edition',
    weight: '480 grams',
    inStock: true
  },
  {
    id: 'res-8',
    title: 'GYNAM Annual Current Affairs Compendium 2025-2026 Magazine',
    type: 'Magazine',
    category: 'All Govt Exams',
    fileSize: '280 Pages Book',
    downloadsCount: 47200,
    rating: 4.96,
    description: 'Full year round-up covering 12 months of Government Schemes, Union Budget, Economic Survey, Awards, Appointments, and Sports.',
    language: 'Bilingual (Eng + Hin)',
    pagesCount: 280,
    chapters: ['Union Budget & Economic Survey Highlights', 'Major Government Schemes 2025-2026', 'International Summits & Bilateral Agreements', '1000 Current Affairs Revision MCQs'],
    updatedDate: '01 July 2026',
    targetExams: ['UPSC CSE', 'APSC CCE', 'SSC CGL', 'Banking'],
    originalPrice: 399,
    price: 219,
    reviewsCount: 2890,
    author: 'GYNAM Editorial Desk',
    badge: 'ANNUAL COMPENDIUM',
    coverBg: 'from-red-700 to-amber-950',
    ...
    publisher: 'GYNAM Publications',
    isbn: '978-93-89102-83-7',
    edition: 'Annual Bumper Edition 2026',
    weight: '450 grams',
    inStock: true
  },
  {
    id: 'res-9',
    title: 'SSC CGL Complete Faculty Printed Study Material Package (Set of 6 Books)',
    type: 'Course Material',
    category: 'SSC',
    fileSize: '920 Pages Box Set',
    downloadsCount: 31000,
    rating: 4.97,
    description: 'Complete syllabus study package including Quant Theory, Reasoning Masterbook, English Grammar Rules, General Studies Mindmaps, Computer Knowledge, and Tier-2 Practice Sets.',
    language: 'English',
    pagesCount: 920,
    chapters: ['Vol 1: Quantitative Aptitude Master Theory', 'Vol 2: Logical & Analytical Reasoning', 'Vol 3: English Language & Comprehension', 'Vol 4: General Studies & Mind Maps', 'Vol 5: Computer Knowledge & Typing Rules', 'Vol 6: 10 Full Length Tier-1 & Tier-2 Mocks'],
    updatedDate: '24 July 2026',
    targetExams: ['SSC CGL Tier 1 & Tier 2'],
    originalPrice: 1799,
    price: 1099,
    reviewsCount: 3890,
    author: 'GYNAM SSC Master Faculty Team',
    badge: 'COMPLETE FACULTY PACK',
    coverBg: 'from-red-900 to-stone-900',
    ...
    publisher: 'GYNAM SSC Master Wing',
    isbn: '978-93-89102-94-3',
    edition: 'SSC CGL 2026 Complete Box',
    weight: '1,420 grams',
    inStock: true
  },
  {
    id: 'res-10',
    title: 'Indian Polity & Governance Standard Textbook by Dr. A. K. Verma',
    type: 'Book',
    category: 'UPSC & State PSC',
    fileSize: '340 Pages Book',
    downloadsCount: 29800,
    rating: 4.93,
    description: 'Standard textbook with conceptual clarity on Constitutional Framework, Federal Structure, Parliamentary Committees, and Supreme Court Landmark Judgments.',
    language: 'English',
    pagesCount: 340,
    chapters: ['Constitutional Development & Preamble', 'Fundamental Rights & Duties', 'Executive, Legislature & Judiciary', 'Constitutional & Non-Constitutional Bodies'],
    updatedDate: '14 July 2026',
    targetExams: ['UPSC CSE', 'APSC CCE', 'State PSC', 'CDS'],
    originalPrice: 599,
    price: 349,
    reviewsCount: 1980,
    author: 'Dr. A. K. Verma (UPSC Mentor)',
    badge: 'STANDARD TEXTBOOK',
    coverBg: 'from-red-800 to-rose-950',
    coverImage: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fit=crop&q=80&w=600',
    images: [
      'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fit=crop&q=80&w=800',
      'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&q=80&w=800'
    ],
    publisher: 'GYNAM Civil Services Press',
    isbn: '978-93-89102-99-8',
...
export const FAQS_DATA: FAQItem[] = [
  {
    id: 'faq-1',
    category: 'General',
    question: 'Why is GYNAM considered India\'s most trusted government exam prep platform?',
    answer: 'GYNAM combines over 15+ years of offline exam teaching experience with cutting-edge technology: AI-powered performance analytics, TCS-pattern mock test engine, daily current affairs summaries, and direct mentorship from top rankers and ex-officers.'
  },
  {
    id: 'faq-2',
  ...
  },
  {
    id: 'faq-3',
    category: 'Mock Tests',
    question: 'Do the GYNAM Mock Tests match the actual TCS exam interface?',
  ...
  },
  {
    id: 'faq-4',
    category: 'App & Access',
    question: 'Can I access GYNAM courses on both mobile app and desktop laptop?',
  ...
  },
  {
    id: 'faq-5',
    category: 'Courses & Batches',
    question: 'Does GYNAM offer dedicated courses for Assam & Northeast State exams?',
    answer: 'Yes! GYNAM has specialized regional expert faculty and dedicated bilingual batches for Assam ADRE 3.0, APDCL, Assam Police SI, APSC, and Assam TET in both Assamese and English mediums.'
  },
  {
    id: 'faq-6',
    category: 'Payments',
    question: 'Is EMI or instalment option available for GYNAM online courses?',
