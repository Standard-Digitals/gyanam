    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl border border-[#ECECEC] overflow-hidden z-10"
        >
          {/* Close button */}
          <button
            onClick={onClose}
            className="absolute top-4 right-4 p-2 text-[#888888] hover:text-[#111111] rounded-full transition z-20"
          >
            <X className="w-5 h-5" />
          </button>

          {/* Header */}
          <div className="p-6 bg-gradient-to-br from-[#111111] to-[#222222] text-white relative">
            <span className="px-3 py-1 bg-[#ED7026] text-white text-[10px] font-extrabold uppercase rounded-full inline-block mb-2">
            ...
            {submitted ? (
              <div className="py-8 text-center space-y-3">
                ...
                <p className="text-xs text-[#555555] max-w-xs mx-auto">
                  Our Senior Mentor will call you on <strong className="text-[#111111]">{formData.phone}</strong> during your requested slot.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-[#FFF8F6] border border-[#ECECEC] rounded-xl text-sm font-semibold focus:outline-none focus:border-[#ED7026]"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 bg-[#FFF8F6] border border-[#ECECEC] rounded-xl text-xs font-semibold"
                    >
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 bg-gradient-to-r from-[#ED7026] to-[#C12223] text-white font-bold rounded-xl text-sm shadow-lg shadow-[#ED7026]/25 hover:scale-[1.02] active:scale-[0.98] transition mt-2"
                >
