...
export const Header: React.FC<HeaderProps> = ({ onOpenSearch, onOpenAuth, onOpenMentorship }) => {
  ...
  return (
    <>
      {/* Top Announcement Bar - Sleek & Uncluttered */}
      <div className="bg-[#111111] text-white py-2 px-4 text-xs border-b border-white/10">
        <div className="max-w-[1320px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5 overflow-hidden">
            <span className="bg-[#ED7026] text-white font-black text-[10px] px-2 py-0.5 rounded uppercase tracking-wider shrink-0">
              NEW BATCH 2026
            </span>
          ...
          <div className="hidden md:flex items-center gap-5 text-gray-300 text-xs shrink-0 font-medium">
            <a href="tel:9117343434" className="flex items-center gap-1.5 hover:text-white transition">
              <Phone className="w-3.5 h-3.5 text-[#ED7026]" />
              <span>Helpline: <strong className="text-white">9117 34 34 34</strong></span>
            </a>
            <span className="text-white/20">|</span>
            <button
              onClick={onOpenMentorship}
              className="hover:text-[#ED7026] transition flex items-center gap-1 font-semibold cursor-pointer"
            >
              <PhoneCall className="w-3.5 h-3.5 text-[#ED7026]" />
      ...
      <header
        className={`sticky top-0 z-40 transition-all duration-300 ease-in-out ${
          isScrolled
            ? 'bg-white/95 backdrop-blur-md py-2 shadow-md border-b border-gray-200/80'
      ...
      >
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2.5 group shrink-0">
            <GyanamLogo className={`transition-all duration-300 ease-in-out group-hover:scale-105 shrink-0 ${
                isScrolled ? 'w-14 h-14 sm:w-16 sm:h-16' : 'w-22 h-22 sm:w-24 sm:h-24'
              }`} />
          </a>
          ...
          <nav className="hidden lg:flex items-center gap-7 xl:gap-9 text-xs xl:text-sm font-semibold text-[#222222]">
              ...
              <AnimatePresence>
                {activeDropdown === 'courses' && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 w-[540px] bg-white rounded-2xl p-6 shadow-2xl border border-gray-200/80 grid grid-cols-2 gap-6 z-50 text-left"
                  >
                    <div>
                      <div className="text-[11px] font-black text-[#ED7026] uppercase tracking-wider mb-3 flex items-center gap-1.5">
                        <BookOpen className="w-3.5 h-3.5" /> Target Exam Batches
                      </div>
                      <ul className="space-y-1.5 text-xs font-semibold text-[#444444]">
                        <li><a href="#courses" className="hover:text-[#C12223] hover:translate-x-1 transition block p-2 rounded-xl hover:bg-[#FFF8F5]">SSC CGL & CHSL 2026 Batch</a></li>
                        <li><a href="#courses" className="hover:text-[#C12223] hover:translate-x-1 transition block p-2 rounded-xl hover:bg-[#FFF8F5]">IBPS & SBI PO / Clerk Masterclass</a></li>
                        <li><a href="#courses" className="hover:text-[#C12223] hover:translate-x-1 transition block p-2 rounded-xl hover:bg-[#FFF8F5]">Assam ADRE 3.0 Special Batch</a></li>
                        <li><a href="#courses" className="hover:text-[#C12223] hover:translate-x-1 transition block p-2 rounded-xl hover:bg-[#FFF8F5]">Railway RRB NTPC & ALP Express</a></li>
                        <li><a href="#courses" className="hover:text-[#C12223] hover:translate-x-1 transition block p-2 rounded-xl hover:bg-[#FFF8F5]">UPSC GS Foundation & State PSC</a></li>
                      </ul>
                    </div>

                    <div className="bg-[#FFF8F5] p-4 rounded-xl border border-[#ED7026]/15 space-y-3 flex flex-col justify-between">
                      <div>
                      ...
                      <a href="#courses" className="block w-full text-center py-2.5 bg-gradient-to-r from-[#ED7026] to-[#C12223] text-white rounded-xl text-xs font-extrabold shadow-sm hover:opacity-95 transition">
                        Explore All Batches →
                      </a>
                    </div>
                  </motion.div>
            ...
            >
              <button className="flex items-center gap-1.5 hover:text-[#C12223] transition py-1 font-semibold whitespace-nowrap cursor-pointer">
                ...
                <span className="bg-[#ED7026] text-white text-[9px] font-black px-1.5 py-0.5 rounded shrink-0">
                  DAILY
                </span>
              ...
              <AnimatePresence>
                {activeDropdown === 'currentAffairs' && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 8 }}
                    transition={{ duration: 0.15 }}
                    className="absolute top-full left-0 w-72 bg-white rounded-2xl p-4 shadow-2xl border border-gray-200/80 z-50 text-left space-y-2"
                  >
                    <div className="text-[11px] font-black text-[#ED7026] uppercase tracking-wider mb-2 flex items-center gap-1.5">
                      <Newspaper className="w-3.5 h-3.5" /> CA & Daily Quiz Hub
                    </div>
                    <ul className="space-y-1 text-xs font-semibold text-[#444444]">
                      <li>
                        <a href="#current-affairs" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] flex items-center justify-between transition">
                      ...
                      <li>
                        <a href="#current-affairs" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] flex items-center justify-between transition">
                          ...
                          <span className="text-[9px] bg-[#ED7026]/10 text-[#ED7026] font-extrabold px-1.5 py-0.5 rounded">Live</span>
                        </a>
                      </li>
                      <li>
                        <a href="#free-resources" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] flex items-center justify-between transition">
              ...
              <AnimatePresence>
                {activeDropdown === 'downloads' && (
                  ...
                  >
                    ...
                    <ul className="space-y-1 text-xs font-semibold text-[#444444]">
                      <li><a href="#free-resources" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">Handwritten Subject Notes PDF</a></li>
                      <li><a href="#free-resources" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">Previous 10 Years Solved PYQs</a></li>
                      <li><a href="#free-resources" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">Official Syllabus & Exam Pattern</a></li>
                      <li><a href="#free-resources" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">Formula Sheets & eBooks</a></li>
                    </ul>
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <AnimatePresence>
                {activeDropdown === 'more' && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 8 }}
                    transition={{ duration: 0.15 }}
                    className="absolute top-full right-0 w-64 bg-white rounded-2xl p-4 shadow-2xl border border-gray-200/80 z-50 text-left space-y-2"
                  >
                    <div className="text-[11px] font-black text-[#ED7026] uppercase tracking-wider mb-2 flex items-center gap-1.5">
                      <Layers className="w-3.5 h-3.5" /> Information & Support
                    </div>
                    <ul className="space-y-1 text-xs font-semibold text-[#444444]">
                      <li><a href="#mentors" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">Faculty & Mentors</a></li>
                      <li><a href="#blog" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">Exam Official Notifications</a></li>
                      <li><a href="#success-stories" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">Toppers' Hall of Fame</a></li>
                      <li><a href="#why-Gyanam" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">About Gyanam EdTech</a></li>
                      <li><a href="#faq" className="hover:text-[#C12223] p-2 rounded-xl hover:bg-[#FFF8F5] block transition">Helpdesk & FAQs</a></li>
                    </ul>
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="hidden sm:flex items-center gap-3">
              ...
              <AnimatePresence>
                {studentPortalOpen && (
                  <motion.div
                    ...
                    className="absolute top-full right-0 mt-2 w-72 bg-white rounded-2xl p-5 shadow-2xl border border-gray-200/80 z-50 text-left space-y-3"
                  >
                    <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                      <div>
                        <h5 className="font-heading font-extrabold text-sm text-[#111111]">Student Portal</h5>
                    ...
                    <ul className="space-y-1.5 text-xs font-semibold text-[#444444]">
                      <li>
                        <button
                          ...
                          className="w-full text-left p-2 rounded-xl hover:bg-[#FFF8F5] hover:text-[#C12223] flex items-center gap-2 cursor-pointer"
                        >
                          <BookMarked className="w-4 h-4 text-[#ED7026]" /> My Enrolled Courses
                        </button>
                      </li>
                      <li>
                        <button
                          ...
                          className="w-full text-left p-2 rounded-xl hover:bg-[#FFF8F5] hover:text-[#C12223] flex items-center gap-2 cursor-pointer"
                        >
                          <History className="w-4 h-4 text-[#ED7026]" /> Download History
                        </button>
                      </li>
                      <li>
                        <button
                          ...
                          className="w-full text-left p-2 rounded-xl hover:bg-[#FFF8F5] hover:text-[#C12223] flex items-center gap-2 cursor-pointer"
                        >
                          <Heart className="w-4 h-4 text-[#ED7026]" /> Saved Notes & PYQs
                        </button>
                      </li>
                    </ul>
                    ...
                    <div className="pt-2 border-t border-gray-100">
                      <button
                        ...
                        className="w-full py-2 bg-[#FFF8F5] border border-[#ED7026]/20 text-[#111111] hover:text-[#C12223] rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 cursor-pointer"
                      >
                        <User className="w-3.5 h-3.5 text-[#ED7026]" /> Student Login
                      </button>
                    </div>
                  </motion.div>
                )}
            ...
            <button
              ...
              className="px-4.5 py-2.5 bg-gradient-to-r from-[#ED7026] to-[#C12223] hover:from-[#C12223] hover:to-[#ED7026] text-white font-extrabold text-xs rounded-xl shadow-md shadow-[#ED7026]/20 hover:shadow-lg transition flex items-center gap-1.5 shrink-0 cursor-pointer"
            >
          ...
          <button
            ...
            className="lg:hidden p-2 text-[#111111] hover:text-[#ED7026] rounded-xl border border-gray-200 bg-white cursor-pointer"
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            >
              <Search className="w-4 h-4 text-[#ED7026]" /> Search courses, exams, study material...
            </button>

            <nav className="flex flex-col space-y-2 font-semibold text-sm text-[#111111]">
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center justify-between py-2 text-left font-bold text-[#111111]"
                >
                  <span>Courses & Batches</span>
                  <ChevronDown className={`w-4 h-4 transition-transform ${activeMobileSub === 'courses' ? 'rotate-180 text-[#ED7026]' : ''}`} />
                </button>
                {activeMobileSub === 'courses' && (
                  <div className="pl-4 py-2 space-y-2 text-xs font-medium text-[#555555] bg-[#FFF8F5] rounded-xl border border-[#ED7026]/15 my-1">
              ...
              <div>
                ...
                >
                  <span className="flex items-center gap-1.5">
                    ...
                    <span className="bg-[#ED7026] text-white text-[9px] font-black px-1.5 py-0.5 rounded">DAILY</span>
                  </span>
                  <ChevronDown className={`w-4 h-4 transition-transform ${activeMobileSub === 'ca' ? 'rotate-180 text-[#ED7026]' : ''}`} />
                </button>
                {activeMobileSub === 'ca' && (
                  <div className="pl-4 py-2 space-y-2 text-xs font-medium text-[#555555] bg-[#FFF8F5] rounded-xl border border-[#ED7026]/15 my-1">
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 transition-transform ${activeMobileSub === 'study' ? 'rotate-180 text-[#ED7026]' : ''}`} />
                </button>
            ...
            <div className="pt-3 border-t border-gray-200 flex flex-col gap-2">
              <button
                ...
                className="w-full py-2.5 text-center font-bold text-sm text-[#111111] bg-gray-50 border border-gray-200 rounded-xl flex items-center justify-center gap-2"
              >
                <User className="w-4 h-4 text-[#ED7026]" /> Student Login
              </button>
              <button
                onClick={() => {
                  onOpenAuth('signup');
                ...
                className="w-full py-3 text-center font-bold text-sm text-white bg-gradient-to-r from-[#ED7026] to-[#C12223] rounded-xl shadow-md"
              >
                Join Now - Start Prep
              </button>
            </div>
