...
export const BentoGrid: React.FC<BentoGridProps> = ({ onOpenMentorship, onExploreMockTests }) => {
  return (
    <section id="features" className="py-20 bg-[#FFF8F6]">
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-6">
          ...
          <motion.div
            ...
            className="lg:col-span-8 p-8 bg-white rounded-3xl border border-[#ECECEC] shadow-xl hover:shadow-2xl relative overflow-hidden group flex flex-col justify-between"
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[#ED7026]/10 to-transparent rounded-full blur-2xl pointer-events-none" />

            <div className="relative z-10 space-y-4">
              <div className="w-12 h-12 rounded-2xl bg-[#ED7026]/10 text-[#ED7026] flex items-center justify-center">
                <Sparkles className="w-6 h-6" />
              </div>
              <span className="text-xs font-extrabold uppercase text-[#ED7026] tracking-wider block">
                Daily Current Affairs Engine
              </span>
              <h3 className="font-heading font-extrabold text-2xl sm:text-3xl text-[#111111]">
            ...
            <div className="mt-6 p-4 bg-[#FFF8F6] rounded-2xl border border-[#ECECEC] flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-2.5 h-2.5 rounded-full bg-[#27AE60] animate-ping" />
                <span className="text-xs font-bold text-[#111111]">Today's Digest Ready (25 July 2026)</span>
              </div>
          ...
          <motion.div
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="lg:col-span-4 p-8 bg-gradient-to-br from-[#111111] to-[#222222] text-white rounded-3xl border border-[#ECECEC] shadow-xl relative overflow-hidden group flex flex-col justify-between"
          >
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-2xl bg-white/10 text-[#ED7026] flex items-center justify-center">
            ...
            <div className="mt-6 p-3 bg-white/10 rounded-2xl border border-white/10 text-center">
              <span className="text-[10px] text-slate-400 block">Predicted Speed Boost</span>
          ...
          <motion.div
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="lg:col-span-4 p-7 bg-white rounded-3xl border border-[#ECECEC] shadow-xl flex flex-col justify-between"
          >
            <div className="space-y-3">
              <div className="w-12 h-12 rounded-2xl bg-[#C12223]/10 text-[#C12223] flex items-center justify-center">
                <FileText className="w-6 h-6" />
              </div>
              <h4 className="font-heading font-extrabold text-xl text-[#111111]">
            ...
            <button
              ...
              className="mt-6 text-xs font-bold text-[#ED7026] flex items-center gap-1 hover:underline"
            >
          ...
          >
            ...
            <a href="#free-resources" className="mt-6 text-xs font-bold text-[#ED7026] flex items-center gap-1 hover:underline">
          ...
          <motion.div
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="lg:col-span-12 p-8 bg-gradient-to-r from-[#FFF8F6] via-white to-[#FFF8F6] rounded-3xl border border-[#ED7026]/30 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6"
          >
            <div className="flex items-center gap-5">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#ED7026] to-[#C12223] text-white flex items-center justify-center shrink-0 shadow-lg shadow-[#ED7026]/30">
                <UserCheck className="w-8 h-8" />
              </div>
              <div>
                <span className="px-2.5 py-0.5 bg-[#ED7026]/10 text-[#ED7026] text-[10px] font-extrabold uppercase rounded-full">
                  1-on-1 Personal Mentorship
                </span>
                <h3 className="font-heading font-extrabold text-2xl text-[#111111] mt-1">
            ...
            <button
              ...
              className="px-6 py-3.5 bg-gradient-to-r from-[#ED7026] to-[#C12223] text-white font-extrabold text-sm rounded-xl shadow-lg shadow-[#ED7026]/25 hover:scale-105 transition shrink-0"
            >
