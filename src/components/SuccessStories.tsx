...
export const SuccessStories: React.FC<SuccessStoriesProps> = ({ onPlayVideo }) => {
  ...
  return (
    <section id="success-stories" className="py-20 bg-[#FFF5F5]">
            ...
            >
              <div>
                ...
                <div className="relative h-64 overflow-hidden bg-slate-900">
                  ...
                  {story.hasVideo && (
                    <button
                      ...
                      className="absolute inset-0 m-auto w-14 h-14 bg-[#C12223]/90 hover:bg-[#C12223] text-white rounded-full flex items-center justify-center shadow-2xl transition hover:scale-110 cursor-pointer"
                ...
                <div className="p-6 space-y-3">
                  <Quote className="w-6 h-6 text-[#C12223]/40" />
              ...
              {/* Card Footer */}
              <div className="p-6 pt-0 border-t border-[#F3DCDD] mt-2 flex items-center justify-between text-xs text-[#555555]">
