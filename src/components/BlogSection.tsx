...
export const BlogSection: React.FC = () => {
  return (
    <section id="blog" className="py-20 bg-[#FFF8F6]">
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <a href="#" className="text-xs font-bold text-[#ED7026] hover:underline flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {BLOG_POSTS.map(post => (
            ...
            >
              ...
              <div className="p-6 pt-0 border-t border-[#ECECEC] mt-4 flex items-center justify-between text-xs text-[#555555]">
                <span>By {post.author}</span>
                <span className="font-bold text-[#ED7026] group-hover:translate-x-1 transition flex items-center gap-1">
